...
class LayerNeuronPruner(LayerScheme):
    """Prunes neurons."""
    def __init__(self, criteria=F.l2norm, prune_bias=True):
        """
        Creates an instance of `LayerNeuronPruner`.
    ...
    def aggregate(self, module, parameter='weight'):
        ...
        agg = T.aggregate_neurons(w.data, self.criteria)
        return agg.view(-1)
    ...
    def __repr__(self):
        return f'<LayerNeuronPruner :: criteria: {self.criteria}, '\
